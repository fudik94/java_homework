...
public class Student {
    ...
    public static Student getRandomStudent(Course... courses) {
        ...
        int year = now.getYear() - random.nextInt(11); // enrolled 0-10 years ago
        ...
        Student student = new Student(id, country, year, age, gender, experience, courses);

        // give each course some random activity, minimum lecture 30
        for (Course course : courses) {
